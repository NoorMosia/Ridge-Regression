...
# Create the cigarette data frame (using the data from your file)
...
# Fit ridge regression with alpha = 0 and lambda = 0.48
...
cat("\nRidge Coefficients (c = 0.48):\n")
print(ridge_coef)


# Check correlation matrix to understand multicollinearity
